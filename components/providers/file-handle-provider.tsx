...
import { getFileHandle, setFileHandle, verifyPermission, clearFileHandle as clearStoredHandle, getLocalData, setLocalData } from "@/lib/file-storage";
...
export function FileHandleProvider({ children }: { children: React.ReactNode }) {
   ...
   */
  const setData = useCallback(async (newData: Record<string, unknown>[]) => {
